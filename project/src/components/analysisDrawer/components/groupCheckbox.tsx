...
import { updateGroupNameToAll } from "@/logic/indexedDb/indexedDb";
...
export const GroupCheckbox: React.FC<Props> = memo(({ groupId, groups, updateCheckbox, updateGroupCheckbox }) => {
